...
__webpack_require__.d(__webpack_exports__, {
  ...
  CLASS_ARROWS: () => (CLASS_ARROWS),
  CLASS_ARROW_NEXT: () => (CLASS_ARROW_NEXT),
  CLASS_ARROW_PREV: () => (CLASS_ARROW_PREV),
  CLASS_CLONE: () => (CLASS_CLONE),
  CLASS_CONTAINER: () => (CLASS_CONTAINER),
  CLASS_FOCUS_IN: () => (CLASS_FOCUS_IN),
  ...
  CLASS_PAGINATION_PAGE: () => (CLASS_PAGINATION_PAGE),
  CLASS_PREV: () => (CLASS_PREV),
  CLASS_PROGRESS: () => (CLASS_PROGRESS),
  CLASS_PROGRESS_BAR: () => (CLASS_PROGRESS_BAR),
  CLASS_ROOT: () => (CLASS_ROOT),
  CLASS_SLIDE: () => (CLASS_SLIDE),
  CLASS_SPINNER: () => (CLASS_SPINNER),
  CLASS_SR: () => (CLASS_SR),
  CLASS_TOGGLE: () => (CLASS_TOGGLE),
  CLASS_TOGGLE_PAUSE: () => (CLASS_TOGGLE_PAUSE),
  CLASS_TOGGLE_PLAY: () => (CLASS_TOGGLE_PLAY),
  CLASS_TRACK: () => (CLASS_TRACK),
  CLASS_VISIBLE: () => (CLASS_VISIBLE),
  DEFAULTS: () => (DEFAULTS),
  EVENT_ACTIVE: () => (EVENT_ACTIVE),
  EVENT_ARROWS_MOUNTED: () => (EVENT_ARROWS_MOUNTED),
  EVENT_ARROWS_UPDATED: () => (EVENT_ARROWS_UPDATED),
  EVENT_AUTOPLAY_PAUSE: () => (EVENT_AUTOPLAY_PAUSE),
  EVENT_AUTOPLAY_PLAY: () => (EVENT_AUTOPLAY_PLAY),
  EVENT_AUTOPLAY_PLAYING: () => (EVENT_AUTOPLAY_PLAYING),
  EVENT_CLICK: () => (EVENT_CLICK),
  EVENT_DESTROY: () => (EVENT_DESTROY),
  EVENT_DRAG: () => (EVENT_DRAG),
  EVENT_DRAGGED: () => (EVENT_DRAGGED),
  EVENT_DRAGGING: () => (EVENT_DRAGGING),
  EVENT_END_INDEX_CHANGED: () => (EVENT_END_INDEX_CHANGED),
  EVENT_HIDDEN: () => (EVENT_HIDDEN),
  EVENT_INACTIVE: () => (EVENT_INACTIVE),
  EVENT_LAZYLOAD_LOADED: () => (EVENT_LAZYLOAD_LOADED),
  EVENT_MOUNTED: () => (EVENT_MOUNTED),
  EVENT_MOVE: () => (EVENT_MOVE),
  EVENT_MOVED: () => (EVENT_MOVED),
  EVENT_NAVIGATION_MOUNTED: () => (EVENT_NAVIGATION_MOUNTED),
  EVENT_OVERFLOW: () => (EVENT_OVERFLOW),
  EVENT_PAGINATION_MOUNTED: () => (EVENT_PAGINATION_MOUNTED),
  EVENT_PAGINATION_UPDATED: () => (EVENT_PAGINATION_UPDATED),
  EVENT_READY: () => (EVENT_READY),
  EVENT_REFRESH: () => (EVENT_REFRESH),
  EVENT_RESIZE: () => (EVENT_RESIZE),
  EVENT_RESIZED: () => (EVENT_RESIZED),
  EVENT_SCROLL: () => (EVENT_SCROLL),
  EVENT_SCROLLED: () => (EVENT_SCROLLED),
  EVENT_SHIFTED: () => (EVENT_SHIFTED),
  EVENT_SLIDE_KEYDOWN: () => (EVENT_SLIDE_KEYDOWN),
    ...
    _create_class(Home, [
        {
            ...
            value: function createReRender() {
                var _this = this;
                var _obj;
                this.splide = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('.splide', (_obj = {
                    type: 'loop',
                    drag: 'free',
                    perPage: 5,
                    autoplay: true,
        ...
        },
        {
            ...
            value: function createReRender() {
                ...
                _barba_core__WEBPACK_IMPORTED_MODULE_2___default().hooks.after(function() {
                    ...
                    _this.pages.contact.createReRender();
                });
            }
        },
        {
